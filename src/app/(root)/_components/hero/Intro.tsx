...
export function Intro() {
  return (
    <main className="flex flex-col justify-center gap-4">
      <ButtonShiny text="Introduction" icon={<Sparkles size={20} className="text-amber-500/90 text-shadow-amber-500 text-shadow-2xs" />} />
      <div>
        <div className="flex flex-col md:flex-row md:items-center sm:gap-2">
          <Typography.Title variant="2/bold">Hi, I’m Fajar —</Typography.Title>
          <WordRotate words={['Informatics Student', 'Software Developer', 'UI/UX Designer']} />
        </div>
